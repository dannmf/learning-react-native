  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.exemplo}>
        ...
        <View style={{ flexDirection: "row", alignItems: "flex-start", height: 80, gap: 8 }}>
      ...
      <View style={styles.exemplo}>
        ...
        <View style={{ position: "relative", height: 100, backgroundColor: "#f0f0f0", borderRadius: 8 }}>
          <View style={[styles.box, { position: "absolute", top: 10, right: 10 }]}>
